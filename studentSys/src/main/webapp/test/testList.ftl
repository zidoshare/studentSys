...
<div class="panel-heading title">${view.title}
    ...
    <span class="pull-right"><a class="btn btn-success" onclick="func.distributeTestQuestionnaire('show');redrawSelects()">分配试卷</a></span>
</div>
...
<div id="template" class="hidden">
    <ul class="nav nav-tabs">
        <li id="add-nav" class="active"><a href="#addTestQuestionnaire" data-toggle="tab">组卷<button type="button" class="close" onclick="closePanel('#add-nav','#addTestQuestionnaire');Util.clearPanel($('#inputQuestionnairePanel'),{hidden:false})" aria-hidden="true">&times;</button></a></li>
        <li id="distribute-nav"><a href="#distribute" data-toggle="tab">分配试卷<button type="button" class="close" onclick="closePanel('#distribute-nav','#distribute')" aria-hidden="true">&times;</button></a></li>
    </ul>
                ...
                <div class="panel-body">
                    ...
                    <form id="testQuestionnaireClass">
                        <div class="form-group">
                            ...
                            <select name="testQuestionnaireClass.testQuestionnaireId" id="testQuestionnaireId" class="selectpicker show-tick form-control" data-live-search="true">
                                <#list questionnaires as q>
                        ...
                        <div class="form-group">
                            ...
                            <select name="testQuestionnaireClass.classId" id="classId" class="selectpicker show-tick form-control" data-live-search="true">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="testQuestionnaireClass.testQuestionnaireStartTime"
                                   id="testQuestionnaireStartTime" placeholder="开始时间">
                        </div>
                        <div class="form-group">
                            <label for="testQuestionnaireEndTime">结束时间：</label>
                            <input type="text" class="form-control" name="testQuestionnaireClass.testQuestionnaireEndTime"
                                   id="testQuestionnaireEndTime" placeholder="结束时间">
                        </div>
                    </form>
                    <span class="pull-right"><button data-style="slide-up" id="save-d-btn" class="btn btn-success ladda-button" onclick="func.distributeTestQuestionnaire('up');"><span class="ladda-label">保存</span></button></span>
                    <br/>
                    <br/>
